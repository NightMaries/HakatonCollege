    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_StudyWeeks", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OldSubjectId = table.Column<int>(type: "integer", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Replacements_Groups_GroupId",
                        column: x => x.GroupId,
                        principalTable: "Groups",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Replacements_Subjects_NewSubjectId",
                        column: x => x.NewSubjectId,
                        principalTable: "Subjects",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Replacements_Subjects_OldSubjectId",
                        column: x => x.OldSubjectId,
                        principalTable: "Subjects",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Schedules_StudyWeeks_StudyWeekId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Replacements_GroupId1",
                table: "Replacements",
                column: "GroupId1");

            migrationBuilder.CreateIndex(
                name: "IX_Replacements_NewSubjectId",
                table: "Replacements",
                column: "NewSubjectId");

            migrationBuilder.CreateIndex(
                name: "IX_Replacements_OldSubjectId",
                table: "Replacements",
                column: "OldSubjectId");
